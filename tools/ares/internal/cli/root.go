...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ares-pp-cli",
		Short: `Ares CLI — Every ARES lookup, plus a local store, offline search, bulk IČO enrichment, and portfolio change-tracking no other ARES…`,
		Long: `Ares CLI — Every ARES lookup, plus a local store, offline search, bulk IČO enrichment, and portfolio change-tracking no other ARES…
...
Health check: run 'ares-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ares-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ares-pp-cli profile list')")
	...
	rootCmd.AddCommand(newEkonomickeSubjektyCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyCeuCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyNotifikaceCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyNrpzsCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyRcnsCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyResCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyRosCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyRpshCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyRsCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyRzpCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektySzrCmd(flags))
	rootCmd.AddCommand(newEkonomickeSubjektyVrCmd(flags))
	...
	rootCmd.AddCommand(newCiselnikyNazevnikyPromotedCmd(flags))
	rootCmd.AddCommand(newStandardizovaneAdresyPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	// Hand-authored transcendence commands (ares_novel.go).
	...
	rootCmd.AddCommand(newInsolvencyWatchCmd(flags))
